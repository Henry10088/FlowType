...
- Added a DPI-independent constraint layout for the status, paired-phones and settings pages.
...
- Workspace tests: 38 passed; 2 interactive input tests skipped by design.
...
| --- | ---: | ---: | ---: |
| `flowtype.exe` | 2,287,616 bytes | 2,296,320 bytes | 8,704 bytes (8.5 KiB, 0.38%) |
